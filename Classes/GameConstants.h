...
#define PlaceNode(sprite, x, y) sprite->setPosition(Point(AppDelegate::SCREEN_WIDTH * x, AppDelegate::SCREEN_HEIGHT * y));
#define ScaleByScreen(sprite) sprite->setScale(AppDelegate::SCREEN_SCALE_FACTOR);
#define ReplaceScene(sceneObject) Director::getInstance()->replaceScene(CCTransitionFlipX::create(1.0f, sceneObject));
#define ReplaceToLeft(sceneObject) Director::getInstance()->replaceScene(CCTransitionSlideInL::create(1.0f, sceneObject));
#define ReplaceToRight(sceneObject) Director::getInstance()->replaceScene(CCTransitionSlideInR::create(1.0f, sceneObject));
