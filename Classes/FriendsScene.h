...
private:
    ...
    void showAllFriends(Ref* sender);
    void showNonPlayingFriends(Ref* sender);
    void showOnlyPlayingFriends(Ref* sender);
    void showOnlyFriendsPlayingWithMyKindOfDevice(Ref* sender);
