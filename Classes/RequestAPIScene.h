...
private:
    ...
    LabelTTF* _pendingRequestLabel;
    
    void sendGifts(Ref* sender);
    void inviteFriends(Ref* sender);
    void challengeFriends(Ref* sender);
    void refreshIncomingRequests(Ref* sender);
    void viewOpenRequestItems(Ref* sender);
